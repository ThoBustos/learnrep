...
function EmptyState() {
  return (
    <div className="flex flex-col items-center gap-5 rounded-[1.5rem] border-[3px] border-[#151515] bg-white/70 py-16 shadow-[6px_6px_0_#151515]">
      <div className="flex size-16 items-center justify-center rounded-full border-[3px] border-[#151515] bg-[#151515]">
        <span className="text-2xl text-[#ffd426]">📚</span>
      </div>
      <div className="text-center">
        <p className="text-xl font-black">Your library is empty</p>
        <p className="mt-1 font-mono text-xs text-[#67606a]">Take a public quiz shared with you to save it here</p>
      </div>
      <Link
        href="/dashboard"
