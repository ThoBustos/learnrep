...
export async function GET() {
  ...
  // "quiz_attempts: read own quiz attempts" RLS lets quiz owners see all attempts on their quizzes.
  // Filtering neq(user_id) gives us attempts by others on quizzes we own.
  ...
  const notifications: AppNotification[] = attempts
