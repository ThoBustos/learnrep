...
// v4 — "Agent Terminal + Hero Strip"
// Terminal shows Claude Code invoking lr. Badge strip of agent names sits under the CTA.
// Pill tag changes to "CLI TOOL FOR AI AGENTS".
