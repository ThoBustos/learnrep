...
// v6 — "Inline flags terminal + agent feature card"
// Terminal shows realistic inline-flags CLI invocation.
// Features grid gains a 4th card: "Runs inside any agent".
// Hero subtext and avatar row hint at agents without a full section.
...
const AGENT_NAMES = ['Claude Code', 'Codex CLI', 'Amp', 'Gemini CLI', 'Copilot CLI', 'Aider', 'Goose', 'Cline']
...
// Inline-flags style: realistic power-user invocation
const SEQUENCE: { delay: number; line: TerminalLine }[] = [
  { delay: 400,  line: { type: 'prompt',  text: '$ lr generate "react hooks" --questions 5 --difficulty medium' } },
  { delay: 1400, line: { type: 'info',    text: 'Generating questions...' } },
...
export default function V6Page() {
  ...
  return (
    <div className="min-h-screen bg-[#fafaf8] text-[#151515]" style={{ fontFamily: 'var(--font-space-grotesk)' }}>
      ...
      <section className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 py-16 sm:px-10 lg:grid-cols-2 lg:items-center lg:gap-16 lg:py-24">
        <div className="flex flex-col gap-6">
          ...
          <p className="max-w-sm text-base leading-relaxed text-[#151515]/60">
            One command from your terminal or AI agent. A live link your whole team can take.
          ...
          <div className="flex items-center gap-2 pt-1">
            <span className="font-mono text-[10px] font-bold uppercase tracking-widest text-[#151515]/40">Works with</span>
            <span className="font-mono text-[10px] font-bold text-[#151515]/60">Claude Code, Codex, Amp, Gemini CLI + more</span>
          </div>
        </div>
      ...
      {/* ── FEATURES (4-card grid with agent card) ───────────────────────────── */}
      <section className="border-t-[3px] border-[#151515]/10 bg-white px-6 py-14 sm:px-10">
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {/* Agent card */}
            <div className="rounded-[1.3rem] border-[3px] border-[#151515] bg-[#151515] p-6 shadow-[5px_5px_0_#ffd426]">
              <div className="mb-4 text-4xl">🤖</div>
              <h3 className="text-xl font-black text-white">Runs inside any agent</h3>
              <div className="mt-3 flex flex-wrap gap-1.5">
                {AGENT_NAMES.map((name) => (
                  <span key={name} className="rounded-full border-[1.5px] border-white/20 px-2 py-0.5 font-mono text-[10px] font-bold text-white/60">
                    {name}
                  </span>
                ))}
              </div>
