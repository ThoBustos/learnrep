...
export default function QuizDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    ...
    >
      ...
      {/* Back nav */}
      <div className="relative z-10 border-b-[3px] border-[#151515] px-5 py-3">
        <Link
          href="/dashboard"
          className="inline-flex items-center gap-2 font-mono text-[10px] font-black uppercase tracking-widest text-[#67606a] hover:text-[#151515]"
        >
          ← Back to feed
        </Link>
      </div>

      <div className="relative z-10 flex flex-col gap-5 p-5 lg:p-8">
        {/* Header card */}
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          {isOwner && (
            <>
              ...
              {pendingRequests > 0 && (
                <div className="flex items-center gap-2 rounded-[1rem] border-[3px] border-[#9c231d] bg-[#ff6b62]/20 px-5 py-3 font-black text-[#9c231d]">
